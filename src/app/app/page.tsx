...
function AppContent() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      const message = sessionStorage.getItem('scout_initial_message');
      if (message) {
        setInitialMessage(message);
        // Clear it after reading so it doesn't persist on refresh
        sessionStorage.removeItem('scout_initial_message');
      }
    }
  }, []);
