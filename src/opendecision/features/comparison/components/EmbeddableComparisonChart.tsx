...
import { getToolColor } from '@/opendecision/shared/utils/chartColors';
...
import { TouchDetectionDebug } from '@/opendecision/shared/components/debug/TouchDetectionDebug';
...
const LazyRadarChart = React.lazy(() => import('@/opendecision/features/comparison/components/ComparisonSection').then(module => ({ default: module.ComparisonSection })));
