...
export const RecommendedToolsSection: React.FC<RecommendedToolsSectionProps> = ({
  ...
  return (
    <section className="h-full flex flex-col bg-white border border-neutral-300 rounded-lg">
      {/* Header */}
      <div className="p-5 border-b border-neutral-200">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-neutral-900">Products</h2>
          <button className="px-4 py-2 bg-neutral-900 text-white text-sm rounded-full hover:bg-neutral-800 transition-colors flex items-center gap-2">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-2.5 text-sm border border-neutral-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-neutral-400 focus:border-neutral-400 placeholder:text-neutral-400"
          />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="p-5 border-b border-neutral-200">
          <div className="flex items-center justify-between mb-3">
            ...
            {addedTools.length > 0 && (
              <a href="#" className="text-xs text-neutral-600 hover:text-neutral-900 flex items-center gap-1">
                Go to DecisionHub
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between mb-1">
                          ...
                          <div className="flex items-center gap-1 px-2 py-1 bg-green-50 rounded">
                            <span className="text-xs font-medium text-green-700">Match Score</span>
                        ...
                        <div className="flex items-center justify-between mt-3">
                          ...
                          <button
                            ...
                            className="px-3 py-1.5 bg-neutral-900 text-white text-xs rounded-full hover:bg-neutral-800 transition-colors flex items-center gap-1"
                          >
                            <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
